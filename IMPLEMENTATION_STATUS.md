...
| 데이터베이스         | 구현 중   | 1~~3차 Ubuntu 확인, 4~~6차 권한·게스트·채팅·요약 migration 로컬 검증                 |
...
| Web UI 기반          | 구현 중   | 보라 MN·슬림 채팅 헤더·접이식 3열·자동 추적·무점멸 갱신·인라인 분기, 시각 E2E 대기   |
...
| 대화·branch·요약     | 구현 중   | CRUD·상태·모델 변경·재생성 분기·자동 요약 구현, 실제 Provider·Ubuntu 검증 대기       |
