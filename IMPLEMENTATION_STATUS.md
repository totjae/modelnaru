...
| 데이터베이스         | 구현 중   | 1~~3차 Ubuntu 확인, 4~~11차 권한·게스트·채팅·요약·사용량·대화 설정·attachment migration 로컬 검증                                                                   |
...
| 파일 처리            | 구현 중   | 텍스트·PDF·JPEG·PNG·WebP 원본 저장, PDF 추출·100페이지/암호/스캔 검증, 이미지 형식·픽셀 검증, 멀티모달 Provider 변환·후속 context·Web UI 구현, OCR·만료 worker 후속 |
