...
프로젝트 기반 구현이 시작되었습니다. pnpm monorepo, Next.js Web, NestJS API healthcheck, 공통 `config.yaml` loader·validator, `apichat-admin` 초기화 도구, PostgreSQL·Valkey와 단일 gateway Compose 구성이 준비되어 있습니다. 인증·사용자·provider·대화 기능은 후속 단계에서 순서대로 연결합니다.
