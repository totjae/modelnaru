...
| USER-AUTH-INT-001  | 통합 | PostgreSQL session  | user_id 연결·최대 3개·idle/absolute 만료·logout 폐기          | 미검증 |
| USER-AUTH-E2E-001  | E2E  | HTTPS 사용자 로그인 | 실제 login·새로고침 유지·관리자 화면 차단·logout              | 미검증 |
...
- `pnpm test`: 47개 통과, Windows에서 symbolic-link 시험 1개 제외
